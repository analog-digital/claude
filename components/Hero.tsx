  ...
  return (
    <section className="relative overflow-hidden bg-[var(--color-primary)] text-white">
      <iframe
        ...
        tabIndex={-1}
      />
      <div className="absolute inset-0 bg-[var(--color-primary)]/80" aria-hidden="true" />
      <div className="relative mx-auto max-w-6xl px-4 py-24 md:py-32">
        ...
        <div className="mt-8 flex flex-wrap gap-4">
          <Link href={hero.primaryCta.href} className="rounded-lg bg-[var(--color-accent)] px-7 py-3.5 font-semibold text-white hover:opacity-90">
